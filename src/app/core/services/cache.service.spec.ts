...
describe("HttpCacheService", () => {
  ...
  //   const httpRes: HttpResponse<any> = new HttpResponse({
  //     body: mockUser,
  //     url: sessionCacheUrl,
  //   });
  ...
  //   const localHttpReq: HttpRequest<any> = new HttpRequest(
  //     "GET",
  //     localCacheUrl
  //   );
  //   const localHttpRes: HttpResponse<any> = new HttpResponse({
  //     body: mockUser,
  //     url: localCacheUrl,
  //   });
  ...
  //   const sessHttpReq: HttpRequest<any> = new HttpRequest(
  //     "GET",
  //     sessionCacheUrl
  //   );
  //   const sessStorageGetSpy = spyOn(LocalStorageService, "getItem");
  //   service.get(sessHttpReq);
  //   expect(sessStorageGetSpy).toHaveBeenCalledWith(
  //     LocalStorageTypes.SESSION,
  //     sessHttpReq.urlWithParams
  //   );
  // });
  ...
  //     sessionCacheUrl
  //   );
  //   const sessHttpRes: HttpResponse<any> = new HttpResponse({
  //     body: mockUser,
  //     url: sessionCacheUrl,
  //   });
  ...
  //   expect(sessStorageRemoveSpy).toHaveBeenCalledWith(
  //     LocalStorageTypes.SESSION,
  //     sessHttpReq.urlWithParams
  //   );
