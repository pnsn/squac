...
@Component({
  ...
  templateUrl: "./widget-edit-threshold.component.html",
  styleUrls: ["./widget-edit-threshold.component.scss"],
})
export class WidgetEditThresholdComponent implements OnInit, OnDestroy {
