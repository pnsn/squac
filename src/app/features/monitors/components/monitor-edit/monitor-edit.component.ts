...
export class MonitorEditComponent implements OnInit, OnDestroy {
  ...
  addTrigger(trigger?: Trigger) {
    ...
    triggerFormGroup.valueChanges.subscribe(value => this.validateTrigger(value, triggerFormGroup))
  ...
  validateTrigger(values, triggerFormGroup) {
    ...
    if(values.value_operator !== 'outsideof' && values.value_operator !== 'within') {
